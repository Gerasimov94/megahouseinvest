const steps = [
  {
    ...
    description:
      "Мы начинаем с диалога, чтобы понять ваш образ жизни, вкусы и мечты.",
  },
  {
    number: "02",
    title: "Проект как портрет",
    description:
      "Наша цель - не просто создать дом, а сделать его отражением вашего образа жизни. Поэтому мы тщательно учитываем все ваши пожелания и предложения.",
  },
  {
    number: "03",
    title: "Юридическая чистота",
    description:
      "Поможем с оформлением участка и получением всех необходимых разрешений.",
  },
  {
    number: "04",
    title: "Комплекс работ",
    description:
      "От нулевого цикла с заливкой фундамента до финальной отделки с установкой всех инженерных систем.",
  },
  {
    number: "05",
    title: "Контроль качества",
    description:
      "На каждом этапе за процессом следят наши опытные руководители и технические специалисты.",
  },
  {
    number: "06",
    title: "Сдача объекта",
    description:
      "Вы получаете не просто коробку, а дом мечты, построенный нашими лучшими специалистами.",
  },
];
        ...
        <div className="relative steps-timeline">
          ...
          <div className="space-y-8 md:space-y-12">
            {steps.map((step, index) => (
              <div
                key={index}
                className={`relative flex items-start gap-4 md:gap-8 step-item ${
        ...
        <div className="text-center mt-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto border border-white/20">
            ...
            <p className="text-white/80 mb-6 leading-relaxed">
              Вы экономите ваше время, нервы и бюджет, получая гарантированный
