        ...
        <SectionWrapper variant="dark" className="pt-16 lg:pt-0">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6 text-white/80 leading-relaxed">
              ...
              <p>
                За годы работы мы построили более{" "}
                <span className="text-accent font-semibold">50 объектов</span>{" "}
                различной сложности: от уютных загородных коттеджей до
                масштабных коммерческих зданий. Каждый проект для нас — это
