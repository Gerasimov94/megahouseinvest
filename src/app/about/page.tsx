  ...
  return (
    <>
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <SectionWrapper variant="light" className="pt-16 pb-4">
          <PageHero
            title="О"
            accent="КОМПАНИИ"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-white/80 leading-relaxed">
                <p>
                  Компания <span className="text-accent font-semibold">МегаХаусИнвест</span> была основана в 2019 году группой
                  опытных строителей и архитекторов, объединенных общей идеей —
                  создавать дома, которые служат поколениями.
                </p>
                <p>
                  За годы работы мы построили более <span className="text-accent font-semibold">50 объектов</span> различной сложности:
                ...
                <p>
                  Наша философия проста: <span className="text-accent">качество, надежность и честность</span> во всем.
            ...
            <div className="relative">
              <video src="https://s3.regru.cloud/megahouseinvest-s3/video/logo_short.mp4" autoPlay preload="auto" muted loop className="w-full h-full object-cover rounded-2xl" />
            </div>
          </div>
        </SectionWrapper>
